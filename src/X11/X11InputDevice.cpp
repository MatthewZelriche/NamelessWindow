...
void X11InputDevice::SubscribeToWindowSpecificXInput2Events(xcb_input_xi_event_mask_t eventMask) {
   m_windowSpecificXInput2SubscribedEvents = eventMask;
}