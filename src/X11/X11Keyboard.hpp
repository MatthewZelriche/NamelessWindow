...
enum KeyValue: int {
   ...
   KEY_LSHIFT = XKB_KEY_Shift_L,
   KEY_RSHIFT = XKB_KEY_Shift_R,
   KEY_LCTRL = XKB_KEY_Control_L,
   KEY_RCTRL = XKB_KEY_Control_R,
   KEY_LSUPER = XKB_KEY_Super_L,
   KEY_RSUPER = XKB_KEY_Super_R,
   KEY_LALT = XKB_KEY_Alt_L,
   KEY_RALT = XKB_KEY_Alt_R,
   KEY_SPACE = XKB_KEY_space,
   KEY_TAB = XKB_KEY_Tab,
   KEY_COMMA = XKB_KEY_comma,
   KEY_PERIOD = XKB_KEY_period,
   KEY_FORWARDSLASH = XKB_KEY_slash,
   KEY_SEMICOLON = XKB_KEY_semicolon,
   KEY_APOSTROPHE = XKB_KEY_apostrophe,
   KEY_BACKSLASH = XKB_KEY_backslash,
   KEY_ENTER = XKB_KEY_Return,
   KEY_LBRACKET = XKB_KEY_bracketleft,
   KEY_RBRACKET = XKB_KEY_bracketright,
   KEY_DASH = XKB_KEY_minus,
   KEY_EQUALS = XKB_KEY_equal,
   KEY_BACKSPACE = XKB_KEY_BackSpace,
   KEY_TILDE = XKB_KEY_grave,
   KEY_F1 = XKB_KEY_F1, 
   KEY_F2 = XKB_KEY_F2, 
   KEY_F3 = XKB_KEY_F3, 
   KEY_F4 = XKB_KEY_F4, 
   ...
   KEY_SCROLL_LOCK = XKB_KEY_Scroll_Lock,
   KEY_NUMLOCK = XKB_KEY_Num_Lock,
   KEY_PRINTSCREEN = XKB_KEY_Print,
   KEY_PAUSE = XKB_KEY_Pause,
   ...
   KEY_END = XKB_KEY_End,
   KEY_CLEAR = XKB_KEY_Clear,
   KEY_NUMPAD_0 = XKB_KEY_KP_0,
   KEY_NUMPAD_1 = XKB_KEY_KP_1,
   KEY_NUMPAD_2 = XKB_KEY_KP_2,
   KEY_NUMPAD_3 = XKB_KEY_KP_3,
   KEY_NUMPAD_4 = XKB_KEY_KP_4,
   KEY_NUMPAD_5 = XKB_KEY_KP_5,
   KEY_NUMPAD_6 = XKB_KEY_KP_6,
   KEY_NUMPAD_7 = XKB_KEY_KP_7,
   KEY_NUMPAD_8 = XKB_KEY_KP_8,
   KEY_NUMPAD_9 = XKB_KEY_KP_9,
   KEY_NUMPAD_PERIOD = XKB_KEY_KP_Decimal,
   KEY_NUMPAD_DIVIDE = XKB_KEY_KP_Divide,
   KEY_NUMPAD_MULTIPLY = XKB_KEY_KP_Multiply,
   KEY_NUMPAD_SUBTRACT = XKB_KEY_KP_Subtract,
   KEY_NUMPAD_ADD = XKB_KEY_KP_Add,
   KEY_NUMPAD_ENTER = XKB_KEY_KP_Enter
};
}  // namespace NLSWIN